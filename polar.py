...
def main():
    ...
    #bot.gripper.open()
    #bot.arm.set_ee_pose_components(roll=(1.57),pitch=1.5,x=0.15, z=0.05)
    #bot.arm.set_single_joint_position("waist", (0*np.pi)/4)
    bot.arm.set_ee_cartesian_trajectory(x=.15)# Limit for xaxis at pick-up height seems to be 0.1 (changed
