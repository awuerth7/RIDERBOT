...
def main():
    ...
    #bot.gripper.open()
    bot.arm.set_ee_pose_components(roll=1.57, pitch=1.5,x=.55, z=0.1)
    #bot.arm.set_single_joint_position("waist", (np.pi)/2)
    #bot.arm.set_ee_cartesian_trajectory(z=-.00)# Limit for xaxis at pick-up height seems to be 0.1 (changed
